        ...
        <div class="section_container">
            ...
            <div class="products_list products_slider clear">
                ...
                <c:forEach items="${list}" var="product">
                    <li> <a  href="product_get.action?id=${product.id}"class="product_image"><img src="${shop}/images/${product.pic}" /></a>
                        <div class="product_info">
                            <h3><a href="#">${product.name}</a></h3>
                            <small>${product.remark}</small> </div>
                        <div class="price_info"> 
                          <button onclick="location.href='sorder_addToForder.action?product.id=${product.id}'"><span class="pr_add">添加购物车</span></button><button class="price_add" title="" type="button"><span class="pr_price">${product.price}</span></button>
                        </div>
                    </li>
                </c:forEach>
                </ul>
